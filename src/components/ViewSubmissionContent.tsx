...
import { getRoleAwareStatusLabel, getLatestRevision } from '../lib/manuscriptStatusLabel';
    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6">
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg p-4">
          ...
          <p className="text-xs text-slate-600 mt-1">Status: <span className="font-semibold text-emerald-700">{m ? getRoleAwareStatusLabel(m, 'AUTHOR', getLatestRevision(manuscriptDetails.revisions)) : 'Not submitted'}</span></p>
